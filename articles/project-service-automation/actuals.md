...
## <a name="using-journals-to-record-costs"></a>Töölehtede kasutamine kulude kirjendamiseks

PSA-s võimaldavad töölehed teil kirjendada kulu või tulu materjali-, tasu-, aja-, kulu- või maksukannete järgi. Töölehel on päis, read ja toiming **Kinnita**. Toome mõned näited, kus võiksite töölehte kasutada.
