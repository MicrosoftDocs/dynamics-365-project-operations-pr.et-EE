...
description: See artikkel kirjeldab tõrkeotsingu teavet, mida on vaja tööülesande ruudustikus töötamisel.
author: ruhercul
ms.date: 07/22/2022
ms.topic: article
ms.product: ''
...
Teenuse Dynamics 365 Project Operations poolt kasutatav ülesande ruudustik on teenuses Microsoft Dataverse majutatud iFrame. Selle kasutamise tulemusena peavad autentimise ja autoriseerimise õigeks toimimiseks olema täidetud erinõuded. See artikkel annab ülevaate levinumatest probleemidest, mis võivad mõjutada ruudustiku renderdamist või tööülesannete haldamist tööjaotuse struktuuris (WBS).
...
2. Tuvastage kasutatava toote tüüp. Seda väärtust kasutatakse PEX-i lõpp-punkti seadmisel. Allalaadimisel on tootetüüp juba PEX-i lõpp-punktis määratletud. Hoidke see väärtus alles.
...
### <a name="mitigation-3-sign-in-to-projectmicrosoftcom"></a>3. Leevendus: Logige sisse saidile project.microsoft.com

Avage oma brauseris uus vahekaart, minge saidile project.microsoft.com ja logige sisse kasutajarolliga, mida kasutate rakendusele Project Operations juurdepääsuks. On oluline, et Microsofti tootesse oleks brauseris sisse logitud ainult üks kasutaja. Tõrketeade „login.microsoftonline.com keeldus ühenduse loomisest“ ilmub kõige sagedamini siis, kui sisse on logitud rohkem kui üks kasutaja, nagu on näidatud järgmisel joonisel.
...
Ülesande ruudustiku laadimiseks peavad autentimise jaoks olema hüpikaknad lubatud. Kui hüpikaknad ei ole lubatud, jääb ekraan laadimisspinneri peale kinni. Järgmine graafika näitab URL-i aadressiribal blokeeritud hüpiksildiga, mille tulemusena jääb spinner lehe laadimisel toppama. 
