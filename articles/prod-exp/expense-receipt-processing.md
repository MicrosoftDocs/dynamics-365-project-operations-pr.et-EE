...
description: Selles artiklis antakse teavet kviitungite optilise märgituvastuse (OCR) töötlemise kohta. Selle funktsiooni eesmärk on parandada kasutajakogemust kuluaruannete loomisel rakenduses Microsoft Dynamics 365 Finance.
author: stsporen
ms.date: 05/14/2020
ms.topic: article
ms.prod: ''
