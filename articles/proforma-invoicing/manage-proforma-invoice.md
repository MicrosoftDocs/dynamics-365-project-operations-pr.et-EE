...
---
# <a name="manage-a-proforma-invoice"></a>Näidisarve haldamine
...
| **Ressursiettevõte** | Määratakse vaikimisi allika tegelikust näitajast. Kirjutuskaitstud väli, mis on redigeerimiseks lukustatud. | Välja saab redigeerida uue arverea üksikasjades, mida allika tegelikud näitajad ei toeta. |
