...
- Uue malli loomisel peate selle veeru lisama. Valige Power Querys suvand **Lisa tingimuslik veerg** ja sisestage uue veeru nimi, näiteks **MudeliID**. Sisestage veeru tingimus, kus juhul, kui Projecti ülesanne ei ole null, siis \<sisestage prognoosi mudeli ID\>; vastasel juhul null.
...
- Uue malli loomisel peate selle veeru lisama. Valige Power Querys suvand **Lisa tingimuslik veerg** ja sisestage uue veeru nimi, näiteks **MudeliID**. Sisestage veeru tingimus, kus juhul, kui prognoosi rea ID ei ole null, siis \<sisestage prognoosi mudeli ID\>; vastasel juhul null.
