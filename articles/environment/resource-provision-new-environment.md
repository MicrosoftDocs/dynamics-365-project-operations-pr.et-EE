...
6. Valige juurutamiseks keskkonna tüüp. Kordustellimusel põhinev prooviversioon võimaldab teil kasutada CDS-keskkonda 30 päeva jooksul. 
     ...
     ![Juurutuse sätted.](./media/1DeploymentSettings.png)
...
9. Kui soovite veenduda, et keskkond on edukalt juurutatud, valige kinnitamiseks käsk **Logi sisse** ja logige keskkonda sisse.
    ...
    ![Keskkonna üksikasjad.](./media/3EnvironmentDetails.png)
...
4. Sisestage paketi nimi ja kirjeldus ning seejärel valige **Salvesta**. Olenevalt Internetiühendusest, võib see protsess võtta aega.
    ...
    ![Laadige pakett varateeki üles.](./media/8UploadPackageToAssetsLibrary.png)
...
4. Veenduge, et järgmiste olemite puhul oleksid rollil õigused **Loe** ja **Lisa lõppu**.
...
3. Käivitage kaardid. Lisateavet leiate teemast [Rakenduse Project Operations topeltkirjutamise vastenduse versioonid](resource-dual-write-maps.md#project-operations-dual-write-maps)
4. Kontrollige, et kõik projektiga seotud kaardid oleksid töötavad olekus.
