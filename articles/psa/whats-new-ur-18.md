...
description: Selles artiklis loetletakse funktsioonid ja parandused, mis on saadaval project service automation update release 18, V3.
author: ruhercul
...
Selles artiklis loetletakse funktsioonid ja parandused, mis on project service automation V3, Update Release 18 jaoks uued või muudetud. Selle versiooni järgu number on V3.10.8.12 ja on üldiselt saadaval 2020. a aprilli enesevärskenduse kaudu.
