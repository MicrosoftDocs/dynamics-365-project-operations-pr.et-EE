...
1.  Allalaadimiskeskuses laadige alla lisandmoodul, mida teie Project Service’i versioon toetab, nt [V2.X](/dynamics365/project-operations/psa/overview#guidance-for-earlier-versions-app-version-2x-or-1x) või [V3.4+](https://www.microsoft.com/download/details.aspx?id=57956).  
